    ...
    lists: [
      {
        ...
        link: '/yahoo/about-us#centreIntro',
        icon: '',
      },
      {
        name: t('pages.about_us.development_course'),
        link: '/yahoo/about-us#history',
        icon: '',
      },
      {
        name: t('pages.about_us.enterprise_vision'),
        link: '/yahoo/about-us#corporate',
        icon: '',
      },
      {
      ...
      },
      {
        ...
        link: '/yahoo/about-us#medicalEquipment',
        icon: '',
      },
      {
        name: t('pages.talent_recruitment.talent_recruitment'),
        link: '/yahoo/talent-recruitment',
        icon: '',
      },
    ],
  },
  {
    ...
    lists: [
      ...
      },
      {
        ...
        icon: '',
        link: '/yahoo/medical-service/muscaeVolitantes',
      },
      {
      ...
      },
      {
        ...
        icon: '',
        link: '/yahoo/medical-service/conjunctivitis',
      },
      {
        name: t('pages.medical_service.xerophthalmia'),
        icon: '',
        link: '/yahoo/medical-service/xerophthalmia',
      },
      {
      ...
      },
      {
        ...
        icon: '',
        link: '/yahoo/medical-service/atropine',
      },
      {

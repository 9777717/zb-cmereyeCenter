...
const menus = computed(() => {
  return [
    ...
    },
    {
      ...
      link: '/yahoo/about-us', // 关于我们
      childMenuList: [
        {
          type: 'link',
          text: t('pages.about_us.center_profile'),
          link: { path: '/yahoo/about-us', hash: '#centreIntro' },
        },
        {
          type: 'link', // 发展历程
          text: t('pages.about_us.development_course'),
          link: { path: '/yahoo/about-us', hash: '#history' },
        },
        {
          type: 'link',
          text: t('pages.about_us.enterprise_vision'),
          link: { path: '/yahoo/about-us', hash: '#corporate' },
        },
        {
          type: 'link',
          text: t('pages.about_us.equipment_centre'),
          link: { path: '/yahoo/about-us', hash: '#medicalEquipment' },
        },
        {
          type: 'link',
          text: t('pages.about_us.feedback'),
          link: { path: '/yahoo/about-us', hash: '#feedback' },
        },
        {
          type: 'link',
          text: t('pages.about_us.enterprise_vision'),
          link: { path: '/yahoo/about-us', hash: '#awards' },
        },
      ],
    },
    {
      ...
      link: { path: '/yahoo/medical-team' }, // 醫療團隊
      childMenuList: [],
    },
    {
      type: 'link',
      text: t('pages.medical_service.medical_service'),
      link: { path: '/yahoo/medical-service' }, // 醫療服務
      childMenuList: [
        {
          type: 'link',
        ...
        },
        {
          ...
          link: { path: '/yahoo/medical-service/maculopathy' },
        },
        {
          type: 'link',
          text: t('pages.medical_service.muscae_volitantes'),
          link: { path: '/yahoo/medical-service/muscaeVolitantes' },
        },
        {
          type: 'link', // 視網膜脫落
          text: t('pages.medical_service.amotioRetinae'),
          link: { path: '/yahoo/medical-service/amotioRetinae' },
        },
        {
          type: 'link',
          text: t('pages.medical_service.glaucoma'),
          link: { path: '/yahoo/medical-service/glaucoma' },
        },
        {
          type: 'link',
          text: t('pages.medical_service.conjunctivitis'),
          link: { path: '/yahoo/medical-service/conjunctivitis' },
        },
        {
          type: 'link',
          text: t('pages.medical_service.xerophthalmia'),
          link: { path: '/yahoo/medical-service/xerophthalmia' },
        },
        {
          type: 'link', // 眼表及角膜疾病
          text: t('pages.medical_service.ocularSurfaceDiseases'),
          link: { path: '/yahoo/medical-service/ocularSurfaceDiseases' },
        },
        {
          type: 'link', // 兒童斜弱視
          text: t('pages.medical_service.strabismusAmblyopia'),
          link: { path: '/yahoo/medical-service/strabismusAmblyopia' },
        },
        {
          type: 'link', // 阿托品滴眼液
          text: t('pages.medical_service.atropine'),
          link: { path: '/yahoo/medical-service/atropine' },
        },
        {
          type: 'link', // 眼矯形及眼眶疾病
          text: t('pages.medical_service.eyeOrthopaedicDisease'),
          link: { path: '/yahoo/medical-service/eyeOrthopaedicDisease' },
        },
        {
          type: 'link', // 醫學驗光配鏡
          text: t('pages.medical_service.medicalOptometry'),
          link: { path: '/yahoo/medical-service/medicalOptometry' },
        },
        {
          type: 'toPage',
    ...
    },
    {
      ...
      link: { path: '/yahoo/ophthalmic-information' },
      childMenuList: [
        {
          type: 'link', // 医生小课堂
        ...
        },
        {
          ...
          link: { path: '/yahoo/ophthalmic-information/publicity' },
        },
        {
          type: 'link', // 希瑪小劇場
          text: t('pages.ophthalmic_information.ophthalmic_little_theatre'),
          link: { path: '/yahoo/ophthalmic-information/littleTheatre' },
        },
        {
          type: 'link', // 文章推薦
          text: t('pages.ophthalmic_information.ophthalmic_press'),
          link: { path: '/yahoo/ophthalmic-information/press' },
        },
        {
          type: 'link', // 文章推薦
          text: t('pages.ophthalmic_information.ophthalmic_article'),
          link: { path: '/yahoo/ophthalmic-information/article' },
        },
        {
          type: 'link', // 健康資訊
          text: t('pages.ophthalmic_information.ophthalmic_message'),
          link: { path: '/yahoo/ophthalmic-information/healthInfo' },
        },
        {
          type: 'link',
          text: '視力測試',
          link: { path: '/yahoo/ophthalmic-information/eyesight' },
        },
      ],
    },
    {
      ...
      link: { path: '/yahoo/process-and-cost' },
      childMenuList: [
        {
          type: 'link', // 費用一覽
          text: t('pages.process_cost.cost'),
          link: { path: '/yahoo/process-and-cost', hash: '#cost' },
        },
        {
          type: 'link', // 就診流程
          text: t('pages.process_cost.process'),
          link: { path: '/yahoo/process-and-cost', hash: '#processed' },
        },
      ],
    },
    {
      ...
      link: { path: '/yahoo/talent-recruitment' },
      childMenuList: [],
    },
    {
      type: 'link',
      text: t('pages.contact_us.contact_us'),
      link: { path: '/yahoo/contact-us' },
      childMenuList: [
        {
          type: 'link', // 診所資料
        ...
        },
        {
          ...
          link: { path: '/yahoo/contact-us/appointmentForm' },
        },
      ],
    },
  ]
...
const toLinks = (data: any) => {
  if (data.type === 'toPage') {
    ...
    router.push(data.link || { path: '/yahoo' })
    menuBool.value = false
  }
}

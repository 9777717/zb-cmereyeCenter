    ...
    <div>
      <div>
        ...
        <div>
          ...
          <div>
            用戶如對我們之私隱政策及慣例有任何疑問，請電郵info@hkcmer.com致希瑪眼科醫療控股有限公司。
          </div>
        </div>
      </div>
      <div>
        ...
        <div>
          ...
          <div>
            <div>
              閣下有權根據《個人資料（私隱）條例》(第486章)的規定，要求查閱或更正閣下之個人資料。如有任何查閱或更正資料的要求，請電郵至info@hkcmer.com。
            ...
            <div>
              希瑪眼科醫療控股有限公司感謝貴客戶長期支持，我們不時與貴客戶分享希瑪眼科醫療控股有限公司的各種最新資訊。如貴客戶不願意收取希瑪眼科醫療控股有限公司的直接促銷材料及/或資訊，可以電郵至：info@hkcmer.com。
            </div>

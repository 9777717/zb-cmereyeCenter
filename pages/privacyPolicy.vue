  ...
  <div class="privacyPolicy">
    <div>
      <div>
        ...
        <div>
          <div>
            以下是希瑪眼科醫療控股有限公司與其附屬公司根據《個人資料(私隱)條例》(第486章)之規定所訂之私隱政策聲明。我們將確保我們之職員將執行有關政策，嚴格保密您的個人資料。
          </div>
          <div>
          ...
          <div>
            用戶如對我們之私隱政策及慣例有任何疑問，請電郵marketing@cmereye.com致希瑪眼科醫療控股有限公司。
          </div>
        </div>
      </div>
      <div>
        ...
        <div>
          <div>資料之目的及用途</div>
          <div>
            <div>我們所收集之資料將用作以下用途：</div>
            <div>
              <p>監控本網站之運作及協助本網站之未來發展；</p>
              <p>匯編有關我們之用戶之整體統計資料以作關於網站使用的分析；</p>
              <p>識別和核實使用本網站所提供服務的用戶的身份；</p>
              <p>就有關或因使用本網站上所提供的服務發生的事項與用戶溝通；</p>
              <p>
        ...
        <div>
          ...
          <div>
            <div>
              閣下有權根據《個人資料（私隱）條例》(第486章)的規定，要求查閱或更正閣下之個人資料。如有任何查閱或更正資料的要求，請電郵至marketing@cmereye.com。
            ...
            <div>
              希瑪眼科醫療控股有限公司感謝貴客戶長期支持，我們不時與貴客戶分享希瑪眼科醫療控股有限公司的各種最新資訊。如貴客戶不願意收取希瑪眼科醫療控股有限公司的直接促銷材料及/或資訊，可以電郵至：marketing@cmereye.com。
            </div>
            <div>此乃中文譯本，如有任何爭議，一切以英文為準。</div>
          </div>
        </div>
      </div>
    </div>

  ...
  meta: [
    {
      name: 'description',
      content:
        '希瑪眼科中心提供全面黃斑病變檢查及治療。黃斑病變的症狀包括: 視力下降、視物扭曲變形及中心視力變差。黃斑病變可以用阿姆斯勒方格表檢查患上黃斑病變的機會。常見的黃斑病變類型有分為濕性黃斑病變以及乾性黃斑病變，老年黃斑病變的成因有很多，當中包括年齡增長、吸煙、飲食習慣攝取高飽和脂肪、眼睛長期被過度日光照射、患有高血壓以及遺傳因素。老年黃斑退化治療包括: 激光光凝凝固、光動力療法、類固醇玻璃體注射及抗血管內皮生長因子玻璃體注射。希瑪眼科中心提供黃斑裂孔眼疾治療，黃斑前膜病變眼疾治療、黃斑水腫治療。治療過程安全可靠，精準度高。',
    },
    {
      name: 'keywords',
      content:
...
const meetArr = [
  ...
  },
  {
    ...
    agree:
      '將藥物注射入玻璃體是其中一個治療黃斑病變的方法。透過把藥物注於患者眼内，直接發揮作用。多個醫學報告顯示，這種方法治療糖尿病黃斑水腫療效良好，超過六成患者能獲得不錯的視功能改善。愈早發現並治療，成效就愈好，經治療後有機會回復正常視力水平。',
  },
]
// 黃斑病變的症狀
const sympotm = [

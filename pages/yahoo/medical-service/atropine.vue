...
<template>
  <div class="atropine">
    ...
    <div class="atropine-nav">
      <yahooserviceNav :arrData="serviceNavigation" :pageName="'atropine'" />
    </div>

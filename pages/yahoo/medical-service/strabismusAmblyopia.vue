...
const serviceNavigation = [
  {
    ...
    anchorLink: '/yahoo/medical-service/strabismusAmblyopia#strabismus',
  },
  {
    anchorName: 'pages.medical_service.strabismusAmblyopia_con.navLists.name2',
    anchorLink: '/yahoo/medical-service/strabismusAmblyopia#kind',
  },
  {
    anchorName: 'pages.medical_service.strabismusAmblyopia_con.navLists.name3',
    anchorLink: '/yahoo/medical-service/strabismusAmblyopia#cure',
  },
  {
    anchorName: 'pages.medical_service.strabismusAmblyopia_con.navLists.name4',
    anchorLink: '/yahoo/medical-service/strabismusAmblyopia#amblyopia',
  },
  {
    anchorName: 'pages.medical_service.strabismusAmblyopia_con.navLists.name5',
    anchorLink: '/yahoo/medical-service/strabismusAmblyopia#amblyopia_kind',
  },
  {
    anchorName: 'pages.medical_service.strabismusAmblyopia_con.navLists.name6',
    anchorLink: '/yahoo/medical-service/strabismusAmblyopia#treat',
  },
]
// 跳转Whatsapp
const goWhatsApp = () => {
...
<template>
  <div class="strabismusAmblyopia">
    ...
    <div class="strabismusAmblyopia-nav">
      <yahooserviceNav :arrData="serviceNavigation" :pageName="'strabismusAmblyopia'" />
    </div>
    <div class="strabismusAmblyopia_nav" :class="{'strabismusAmblyopiaNav-en': locale === 'en'}">
      ...
      <div id="kind">
        ...
        <div class="serviceBtnStyle">
          <yahoo-service-button-icon
            :str="$t('pages.medical_service.strabismusAmblyopia_con.btn.name1_1') + '\n' + $t('pages.medical_service.strabismusAmblyopia_con.btn.name1_2')"
      ...
      <div id="cure">
        ...
        <div>
          <div v-for="(item, index) in strabismusList5" :key="index">
            ...
            <div>
              <div>
                <img :src="item.img" :title="item.img_title" :alt="item.img_alt" />
              </div>
      ...
      <div id="amblyopia">
        ...
        <div>
          <div>
            <img
              src="https://static.cmereye.com/imgs/2023/06/2ed1badaabb9c9cb.png" title="兒童弱視矯正" alt="兒童配戴眼鏡以矯正弱視"
            />
          </div>
          <div class="strabismusAmblyopia_text_p_span">
        ...
        <div id="amblyopia_kind">
          ...
          <div>
            <div v-for="(item, index) in amblyopiaList1" :key="index">
              <div><img :src="item.img" :title="item.img_title" :alt="item.img_alt" /></div>
              <div>
                <div>{{ $t(item.title) }}</div>
                <div class="strabismusAmblyopia_text_p_span">
                  {{ $t(item.text) }}
        ...
        <div class="serviceBtnStyle">
          <yahoo-service-button-icon
            :str="$t('pages.medical_service.strabismusAmblyopia_con.btn.name2_1') + '\n' + $t('pages.medical_service.strabismusAmblyopia_con.btn.name2_2')"
      ...
      <div id="treat">
        ...
        <div>
          <div v-for="(item, index) in treatList1" :key="index">
            <div>
              <img :src="item.svg" :alt="item.img_alt" :title="item.img_title" />
              <div>{{ $t(item.title) }}</div>
            </div>
            <div>
              <div>

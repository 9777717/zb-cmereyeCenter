...
<template>
  <div>
    ...
    <div class="xeroheader">
      ...
      <yahooserviceNav :arrData="serviceNavigation" :pageName="'xeroheader'" />
      <!-- 内容 -->
      <div class="xerophthalmia" :class="{'xerophthalmia-en': locale === 'en'}">
          ...
          <div>
            <div>
              <img data-cfsrc="https://static.cmereye.com/imgs/2023/06/84382a189b0f3a65.png"
                ...
                title="乾眼症症狀" alt="女患者眼睛不適為乾眼症症狀表現" src="https://static.cmereye.com/imgs/2023/06/84382a189b0f3a65.png" />
            </div>
          </div>
        </div>
        <!-- 乾眼症症狀 -->
        <div id="xerophthalmiaType">
          ...
          <div>
            <div v-for="(item, index) in xerophthalmiaType" :key="index">
              <div><img :src="item.img" :alt="item.img_alt" :title="item.img_title" srcset="" /></div>
              <div>{{ $t(item.text) }}</div>
            </div>
          </div>
        ...
        <div id="factor">
          ...
          <div>
            ...
            <div>
              <img src="https://hkcmereye.com/template/default/picture/gyz/Group83.jpg" title="乾眼症_淚膜三層" alt="乾眼症淚膜三層結構" v-if="locale === 'en'">
              <img src="https://static.cmereye.com/imgs/2023/10/8bcf58c7b6d0adf8.jpg" title="乾眼症_淚膜三層" alt="乾眼症淚膜三層結構" v-else>
            </div>
          </div>
          <div>
            <div v-for="(item, index) in factor" :key="index">
              <div>
                <img :data-cfsrc="item.img" :srcset="`${item.mbImg} 768w, ${item.img}`" :alt="item.img_alt" :title="item.img_title"
                  :src="item.img" />
              </div>
              <div>
          ...
          <div>
            ...
            <div>
              ...
              <div>
                ...
                <div>
                  <img src="https://static.cmereye.com/imgs/2023/05/96be300a751eee94.png" title="乾眼症自我檢測_淚液測試" alt="淚液測試試紙為乾眼症自我檢測方法" />
                </div>
              </div>
            </div>
          </div>
        ...
        <div id="means">
          ...
          <div>
            ...
            <div v-for="(item, i) in means" :key="i">
              ...
              <div>
                <div>
                  <img src="https://static.cmereye.com/imgs/2023/05/bc830caf2d8498fa.png" title="乾眼症治療_脈衝光治療" alt="脈衝光治療為乾眼症治療方法" />
                </div>
                <div>
                  <div>
                    <div>
            ...
            <div>
              ...
              <div>
                <img src="https://static.cmereye.com/imgs/2023/05/cf53e666d96890d0.png" title="乾眼症治療_人工淚液" alt="人工淚液為乾眼症治療方法" srcset="" />
              </div>
            </div>
            <!-- 眼藥水 -->
            <div>
    ...
    <div>
        ...
        <div>
          <div>
            <div @click.stop="getPdf('xerophthalmia.pdf', '乾眼症')">
              <img src="https://static.cmereye.com/imgs/2023/05/a7f10818e63e3e82.png" title="乾眼症" alt="乾眼症_小冊子" srcset="" />
            </div>
            <div @click.stop="getPdf('xerophthalmia.pdf', '乾眼症')">
      ...
      <yahooFormFooterInfo :bg="`background:${backgd[0]}background:${backgd[1]}background:${backgd[2]}`"
        :co="`color:${'#b6b3e0;'}`" />
    </div>
    <yahooPageFooterMenu />
  </div>

...
const backgd = [
  '#f7d6cf;',
  '-webkit-linear-gradient(to right, #eeb8ae, #f7d6cf);',
  'linear-gradient(to right, #eeb8ae, #f7d6cf);',
]
// 跳转Whatsapp
const goWhatsApp = () => {
  window.open(
...
<template>
  <div class="amotioRetinae">
    ...
    <yahooserviceNav :arrData="serviceNavigation" :pageName="'amotioRetinae'" />
    <div class="amotioRetinae_nav" :class="{'amotioRetinaeNav-en': locale === 'en'}">
      ...
      <div id="faq">
        ...
        <div>
          <yahooPageCollapse :answer="meetArr" :downarr="'amotioRetinae'" :style="{ '--subassembly-color': '#eab1a6' }" />
        </div>
      </div>
    </div>
    <div>

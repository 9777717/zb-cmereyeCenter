...
<template>
  <div class="contact_eye">
    ...
    <yahooFormFooterInfo
      ...
      :co="`color:${'#6a91cf;'}`"
    />
    <yahooPageInformation :service-navigation="serviceNavigation" />
    <yahooPageFooterMenu />
    <client-only>
      <el-dialog

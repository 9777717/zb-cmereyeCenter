...
const getData = async () => {
  ...
  // const { data }:any= await useFetch('https://api.instagram.com/oauth/authorize?client_id=720994616158677&redirect_uri=https://www.hkeyecmer.com/testig&scope=user_profile,user_media&response_type=code')
  // const { data }:any = await useFetch('https://api.instagram.com/oauth/access_token',{
  //   client_id: '720994616158677',
  //   client_secret: '',
  //   code: '',
  //   grant_type: 'authorization_code',
  //   redirect_uri: 'http://127.0.0.1:3004/testig'
  // })
